...
const _managerLabel = (window.LOOM_CONFIG?.managerLabel) || '과장';
const ROLE_LABEL = { admin: '관리자', leader: '팀장', manager: _managerLabel, member: '팀원', viewer: '손님' };
...
function openPermModal() {
  ...
  const roleLabel = { admin: '관리자', leader: '팀장', manager: _managerLabel, member: '팀원', viewer: '손님' };
  const rows = [
